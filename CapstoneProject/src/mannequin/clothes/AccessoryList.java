...
public class AccessoryList {
	...
	public AccessoryList() {
		...
		Accessory accessory1 = new Accessory("Hot", "", "Non-Binary", whiteHat);
		...
		Accessory accessory2 = new Accessory("Hot", "", "Non-Binary",blackHat);
		...
		Accessory accessory3 = new Accessory("Cold", "", "Non-Binary",blackBeanie);
		...
		Accessory accessory4 = new Accessory("Cold", "", "Non-Binary",grayBeanie);
		...
		Accessory accessory5 = new Accessory("Cold", "", "Non-Binary",greenBeanie);
